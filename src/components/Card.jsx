...
const card = () => {
  return (
  <div>
    <h1 className='bg-navColor text-textColor border-y-2 border-black/40 my-6 h-16 items-center justify-center flex text-2xl'>Como Podemos Ajudar</h1>
    <div className='mx-10 md:mx-20 grid grid-cols-1 md:grid-cols-3 gap-8 tracking-wider text-textColor'>
